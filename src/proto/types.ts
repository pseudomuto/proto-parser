...
/**
 * Represents parsed proto definitions from a namespace.
 * Contains all services, messages, and enums found during parsing.
 *
 * @public
 * @since 0.3.0
 */
export interface ParsedProto {
  /** Array of service definitions found in the namespace */
  services: Service[];
  /** Array of message definitions found in the namespace */
  messages: Message[];
  /** Array of enum definitions found in the namespace */
  enums: Enum[];
  /** Array of extensions found in the namespace (optional for future use) */
  extensions?: Extension[];
}
